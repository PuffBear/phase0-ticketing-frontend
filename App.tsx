...
import { signInWithGoogle, signOutFirebase } from './services/firebaseAuth';
...
const AppRoutes: React.FC = () => {
  ...
  const handleLogout = async () => {
    try {
      await signOutFirebase(); // Sign out from Firebase (clears in-memory token)
      await apiPost('/auth/logout', {}); // Clear the app session cookie
    } catch {
      // ignore
    } finally {
      setAuthUser(null);
